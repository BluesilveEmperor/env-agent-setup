...
.PARAMETER Environment
    要检测的环境类型：android, harmonyos, ios, python, java, nodejs, rust, go, cpp, web, ai-agent, ohos-skills, all
.EXAMPLE
...
param(
    ...
    [ValidateSet("android", "harmonyos", "ios", "python", "java", "nodejs", "rust", "go", "cpp", "web", "ai-agent", "ohos-skills", "all")]
    [string]$Environment
)
